...
const CertificateGallery = ({ title, images = [], onBack }) => {
  ...
  useEffect(() => {
    ...
    // Observe individual image cards
    ...
    <div style={pageStyle}>
      <div style={contentStyle}>
        <div style={headerStyle}>
          ...
          <div>
            <p style={eyebrowStyle}>Certificates &amp; event photos</p>
          ...
          <AnimatePresence>
            {images.length === 0 ? (
              <div style={emptyStateStyle}>
                No images available for this certification yet.
              </div>
            ) : (
                ...
                >
                  ...
                  >
                    ...
                    <motion.img
                      ...
                      initial={{ opacity: 0 }}
                      animate={{
                        opacity: loadedMap[index] && visibleImages[`image-${index}`] ? 1 : 0,
                      }}
                      exit={{ opacity: 0 }}
                      transition={{
                        duration: 0.5,
